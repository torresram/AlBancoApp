        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Usuarios_Canchas_CanchaId",
                        column: x => x.CanchaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoraPartido = table.Column<TimeSpan>(type: "time", nullable: false),
                    JugadoresNecesarios = table.Column<int>(type: "int", nullable: false),
                    PrecioPorJugador = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Convocatorias_Canchas_CanchaId",
                        column: x => x.CanchaId,
                        principalTable: "Canchas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Convocatorias_Usuarios_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Confirmaciones_Convocatorias_ConvocatoriaId",
                        column: x => x.ConvocatoriaId,
                        principalTable: "Convocatorias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Confirmaciones_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Confirmacion_Usuario_Convocatoria",
                table: "Confirmaciones",
                columns: new[] { "UsuarioId", "ConvocatoriaId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Confirmaciones_ConvocatoriaId",
                table: "Confirmaciones",
                column: "ConvocatoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_Convocatorias_CanchaId",
                table: "Convocatorias",
                column: "CanchaId");

            migrationBuilder.CreateIndex(
                name: "IX_Convocatorias_UsuarioId",
                table: "Convocatorias",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Usuarios_CanchaId",
                table: "Usuarios",
                column: "CanchaId");
